...
export const DragCards = () => {
  return (
    <section className="relative grid min-h-screen w-full place-content-start overflow-hidden bg-neutral-950 rounded-2xl">
...
const Cards = () => {
  ...
  return (
    <div className="absolute inset-0 z-10 hidden sm:block" ref={containerRef}>
      <Card
